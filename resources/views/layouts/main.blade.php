    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex item-center flex-col md:flex-row">
                ...
                <li class="md:ml-16 ml-10">
                    <a href="{{route('movies.index')}}" class="hover:text-gray-300 mt-4 md:mt-0">Movies</a>
                </li>
                <li class="md:ml-6 ml-10">
                    <a href="#" class="hover:text-gray-300 mt-4 md:mt-0">TV Shows</a>
                </li>
                <li class="md:ml-6 ml-10">
                    <a href="#" class="hover:text-gray-300 mt-4 md:mt-0">Actors</a>
                </li>
            </ul>
